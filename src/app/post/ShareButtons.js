...
export default function ShareButtons({ title }) {
  ...
  return (
    <div className="share-section">
      <h3 style={{ fontSize: '1.2rem', marginBottom: '16px', fontWeight: 500 }}>వ్యాసాన్ని పంచుకోండి (Share):</h3>
      <div className="share-buttons">
        ...
        }} className="share-btn instagram-btn" title="Share on Instagram">
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
        ...
        <button onClick={handleCopyLink} className="share-btn copy-btn" title={copied ? 'Copied!' : 'Copy Link'}>
          <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
