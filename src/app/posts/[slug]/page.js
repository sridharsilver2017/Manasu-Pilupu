    ...
    <article className="single-post animate-fade-in">
      ...
      <div className="post-container">
        ...
        <div className="support-message">
          <p>
            ఇంటర్నెట్ అంతా ప్రకటనలతో నిండిపోతున్న ఈ రోజుల్లో, మన తెలుగు భాషలో ఒక స్వచ్ఛమైన, ప్రశాంతమైన వేదికను అందించాలనేదే నా ప్రయత్నం. నా రచనలు మీకు నచ్చినట్లయితే మరియు ఈ ప్రయాణం ఇలాగే ముందుకు సాగడానికి మద్దతు ఇవ్వాలనుకుంటే, మీ వీలును బట్టి ఎంతైనా ఆర్థిక సాయం అందించవచ్చు. మీ ప్రోత్సాహమే నాకు బలం.
          </p>
